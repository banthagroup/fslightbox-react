...
beforeEach(() => {
    ...
    fsLightbox.elements.sourceMainWrappers[0] = { current: { classList: { add: jest.fn() } } };
    fsLightbox.elements.sourceMainWrappers[1] = { current: { classList: { add: jest.fn() } } };
    fsLightbox.elements.sourceMainWrappers[2] = { current: { classList: { add: jest.fn() } } };
});
...
test('runPositiveSwipedXActions', () => {
    ...
    expect(fsLightbox.elements.sourceMainWrappers[0].current.classList.add).not.toBeCalled();
    expect(fsLightbox.elements.sourceMainWrappers[1].current.classList.add).toBeCalledWith(TRANSFORM_TRANSITION_CLASS_NAME);
    ...
    expect(fsLightbox.elements.sourceMainWrappers[0].current.classList.add).toBeCalledWith(TRANSFORM_TRANSITION_CLASS_NAME);
    expect(fsLightbox.elements.sourceMainWrappers[1].current.classList.add)
...
test('runNegativeSwipedXActions', () => {
    ...
    expect(fsLightbox.core.slideIndexChanger.changeTo).not.toBeCalled();
    expect(fsLightbox.elements.sourceMainWrappers[1].current.classList.add).toBeCalledWith(TRANSFORM_TRANSITION_CLASS_NAME);
    expect(fsLightbox.elements.sourceMainWrappers[2].current.classList.add).not.toBeCalled();
    expect(fsLightbox.collections.sourceMainWrapperTransformers[1].zero).toBeCalled();
    ...
    expect(fsLightbox.elements.sourceMainWrappers[1].current.classList.add)
        .toHaveBeenNthCalledWith(2, TRANSFORM_TRANSITION_CLASS_NAME);
    expect(fsLightbox.elements.sourceMainWrappers[2].current.classList.add).toBeCalledWith(TRANSFORM_TRANSITION_CLASS_NAME);
