...
describe('transforming all three stage source holders, because there are three slides', () => {
    beforeEach(() => {
    ...
    describe('previous source holder', () => {
    ...
    describe('current source holder', () => {
...
describe('transforming only current and next stage source holder, because there are only 2 slides', () => {
    beforeEach(() => {
    ...
    describe('previous source holder', () => {
        it('should not call setSourceHolder with previous source holder', () => {
...
describe('transforming only current stage source holder, because there is only 1 slide', () => {
    beforeEach(() => {
    ...
    describe('current source holder', () => {
        it('should call setSourceHolder with current source holder', () => {
            expect(sourceHolderTransformerMock.setSourceHolder).toBeCalledWith(fsLightbox.elements.sourceHolders[0]);
        });
    ...
    describe('next source holder', () => {
        it('should not call setSourceHolder with next source holder', () => {
