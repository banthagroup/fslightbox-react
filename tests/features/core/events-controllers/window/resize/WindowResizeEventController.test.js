...
describe('adding and removing resize listener from window', () => {
    ...
    beforeEach(() => {
        // setting sources Holders to divs due to resize listener resizes sources Holders and we don't use enzyme
...
describe('checking if methods that supposed to be called when resize event occurs are called', () => {
    ...
    it('should should transform all stage sources Holders', () => {
